...
<div class="page-layout">
    ...
    <div>
        ...
        <input type="text" name="nama_rujukan" value="{{ old('nama_rujukan', $rujukan->nama_rujukan ?? '') }}"
               class="w-full bg-white/5 border @error('nama_rujukan') border-red-500/50 @else border-white/10 @enderror
    ...
    <div>
        ...
        <select name="produsen_id"
                class="w-full bg-white/5 border @error('produsen_id') border-red-500/50 @else border-white/10 @enderror
    ...
    <div>
        ...
        <input type="url" name="link_rujukan" value="{{ old('link_rujukan', $rujukan->link_rujukan ?? '') }}"
               class="w-full bg-white/5 border @error('link_rujukan') border-red-500/50 @else border-white/10 @enderror
                      text-gray-200 text-sm rounded-lg px-3 py-2.5 placeholder-gray-600
                      focus:outline-none focus:border-green-400/50 transition"
               placeholder="https://...">
        @error('link_rujukan')
    ...
    <div>
        ...
        <input type="file" name="gambar_rujukan" accept="image/*"
               class="w-full bg-white/5 border @error('gambar_rujukan') border-red-500/50 @else border-white/10 @enderror

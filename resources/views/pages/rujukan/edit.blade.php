{{-- resources/views/pages/rujukan/edit.blade.php --}}
...
<div class="max-w-2xl space-y-4">
    ...
    <div class="flex items-center gap-2 text-xs text-gray-500">
        ...
        <span class="text-gray-300">Edit: {{ $rujukan->nama_rujukan }}</span>
    </div>

    <div class="card-panel p-6">
        <h2 class="text-sm font-semibold text-gray-200 mb-5">
            <i class="fas fa-file-alt text-green-400 mr-2"></i>Edit Rujukan
        </h2>

        <form action="{{ route('admin.rujukan.update', $rujukan) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')

...
<div class="max-w-2xl space-y-4">
    ...
    <div class="flex items-center gap-2 text-xs text-gray-500">
        ...
        <span class="text-gray-700">Ubah Satuan</span>
    </div>

    <div class="card-panel p-6">
        <h2 class="text-sm font-semibold text-gray-600 mb-5">
            <i class="fas fa-edit text-green-400 mr-2"></i>Ubah Satuan
        </h2>
        ...
        <form action="{{ route('admin.satuan.update', $satuan) }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="simbol" value="{{ old('simbol', $satuan->simbol) }}"
                           class="mt-2 w-full rounded-xl border border-gray-200 px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent">
                    @error('simbol')
                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="nilai_konversi" value="{{ old('nilai_konversi', $satuan->nilai_konversi) }}"
                           class="mt-2 w-full rounded-xl border border-gray-200 px-4 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent">

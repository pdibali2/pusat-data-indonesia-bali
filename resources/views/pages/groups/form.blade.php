...
<div>
    ...
    <input type="text" name="title" value="{{ old('title', $group->title ?? '') }}"
           class="w-full bg-white/5 border @error('title') border-red-500/50 @else border-gray-600 @enderror
                  text-gray-700 text-sm rounded-lg px-3 py-2.5 placeholder-gray-600

...
<footer class="bg-stikom text-white" role="contentinfo">
        ...
        <div class="py-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center gap-3 mb-5">
                    <img src="{{ asset('logo.png') }}" alt="Logo PDIB" class="w-10 h-10 rounded-xl object-cover"/>
                    <div>
                ...
                <a href="{{ route('langganan') }}"
                   class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-stikom-accent hover:bg-yellow-400 text-stikom text-sm font-black transition-colors">

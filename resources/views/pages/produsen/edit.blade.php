{{-- resources/views/pages/produsen/edit.blade.php --}}
@extends('layouts.main')

@section('title', 'Edit Produsen')
...
<div class="max-w-2xl space-y-4">
    ...
    <div class="flex items-center gap-2 text-xs text-gray-500">
        ...
        <span class="text-gray-300">Edit: {{ $produsen->nama_produsen }}</span>
    </div>

    <div class="card-panel p-6">
        <h2 class="text-sm font-semibold text-gray-200 mb-5">
            <i class="fas fa-industry text-green-400 mr-2"></i>Edit Produsen
        </h2>

        <form action="{{ route('admin.produsen.update', $produsen) }}" method="POST">
            @csrf
            @method('PUT')
            @include('pages.produsen.form')

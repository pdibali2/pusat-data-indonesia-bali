...
<div class="page-layout">
    ...
    <div>
        ...
        <input type="text" name="nama_produsen" value="{{ old('nama_produsen', $produsen->nama_produsen ?? '') }}"
               class="w-full bg-white/5 border @error('nama_produsen') border-red-500/50 @else border-white/10 @enderror
    ...
    <div>
        ...
        <input type="text" name="nama_contact_person" value="{{ old('nama_contact_person', $produsen->nama_contact_person ?? '') }}"
               class="w-full bg-white/5 border @error('nama_contact_person') border-red-500/50 @else border-white/10 @enderror
                      text-gray-200 text-sm rounded-lg px-3 py-2.5 placeholder-gray-600
                      focus:outline-none focus:border-green-400/50 transition"
    ...
    <div>
        ...
        <input type="text" name="kontak" value="{{ old('kontak', $produsen->kontak ?? '') }}"
               class="w-full bg-white/5 border @error('kontak') border-red-500/50 @else border-white/10 @enderror
                      text-gray-200 text-sm rounded-lg px-3 py-2.5 placeholder-gray-600
                      focus:outline-none focus:border-green-400/50 transition"
    ...
    <div>
        ...
        <textarea name="alamat" rows="3"
                  class="w-full bg-white/5 border @error('alamat') border-red-500/50 @else border-white/10 @enderror
                         text-gray-200 text-sm rounded-lg px-3 py-2.5 placeholder-gray-600

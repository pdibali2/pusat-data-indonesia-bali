                            ...
                            <div class="relative flex flex-col overflow-hidden bg-white ring-2 ring-sky-400 shadow-2xl shadow-sky-500/15 -my-3 z-10
                                ...
                                <div class="flex flex-col flex-1 p-[14px] pt-4">
                                    ...
                                    <ul class="flex-1 overflow-y-auto space-y-2 mb-10 pr-0.5"
                                        style="max-height: 140px; scrollbar-width: thin; scrollbar-color: rgba(16,185,129,.25) transparent;">
                                    ...
                                    @elseauth
                                        <form method="POST" action="{{ route('transaksi.checkout') }}">
                                            ...
                                            <button type="submit"
                                                    class="w-full py-3 text-[10px] font-black text-stikom hover:text-white bg-stikom-accent
                                                        hover:bg-stikom-accent transition-colors duration-200 font-poppins

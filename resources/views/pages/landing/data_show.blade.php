        ...
        <div class="max-w-6xl mx-auto px-6 pt-24 pb-0 relative z-10">
            ...
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex flex-wrap items-center gap-x-4 gap-y-2 mb-6 fade-up d3 text-xs text-slate-400">
                        ...
                        @endif
                        <span class="inline-flex items-center gap-1.5">
                            <svg class="w-3 h-3 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>

        ...
        <div class="grid lg:grid-cols-2 gap-12 items-end mb-16 fade-up">
            <div>
                <h2 id="langganan-heading" class="text-3xl sm:text-4xl font-black font-poppins text-stikom leading-tight">
                    Pilih Paket yang <br><span class="text-stikom-blue">Sesuai Kebutuhan</span>
                </h2>
            </div>
        </div>
                ...
                <div class="{{ $pricings->count() > 1 ? 'grid sm:grid-cols-2 lg:grid-cols-' . min($pricings->count(), 3) . ' gap-6' : '' }}">
                    ...
                    @forelse($pricings as $plan)
                        ...
                        <div class="relative overflow-hidden shadow-2xl
                                    {{ $isPopular
                                        ? 'ring-2 ring-stikom-blue shadow-stikom/30'
                            ...
                            {{-- Top badge --}}
                            @if($isPopular)
                                <div class="bg-stikom-blue py-2 px-6 flex items-center justify-between">
                            ...
                            @else
                                <div class="border-b border-stikom-blue py-2 px-6">
                                    <span class="text-stikom-blue text-xs font-bold uppercase tracking-widest">Paket</span>
                                </div>
                            @endif
            ...
            @if($pricings->count() === 1)
                <div class="lg:col-span-3 fade-up" style="animation-delay:0.15s">
                    ...
                    <div class="mt-6 flex flex-col sm:flex-row gap-3">
                        <a href="{{ route('langganan') }}"
                           class="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-stikom-blue text-white font-black text-sm hover:bg-blue-700 transition-all duration-200 shadow-lg">

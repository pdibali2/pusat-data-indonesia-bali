...
<div class="page-layout max-w-lg mx-auto">
    ...
    <div class="card-panel">
        <div class="px-6 py-4 border-b border-gray-100">
            <h1 class="text-base font-bold text-gray-800">Edit Klasifikasi</h1>
            <p class="text-xs text-gray-500 mt-0.5">Perbarui nama klasifikasi.</p>
        </div>

        <form action="{{ route('admin.klasifikasi.update', $klasifikasi) }}" method="POST" class="px-6 py-5 space-y-5">
            @csrf @method('PUT')
